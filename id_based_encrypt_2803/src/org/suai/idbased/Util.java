...
public class Util {
    ...
    static void usage()
    {
        System.out.println("--Личностная криптосистема по схеме Кокса --");
        System.out.println("");
        ...
        System.out.println(
                "Напечатайте --help чтобы увидеть подробную информацию о командах программы");
    ...
    {
        System.out.println(
                "Внимание: знаком [] отмечены необязательные параметры, порядок параметров неважен");
        System.out.println();
        System.out.println("Информация о команде setup:");
        System.out.println("------------------");
        System.out.println(
                "Setup выполняет начальную инициализацию Public Key Generator - "
                + "генерацию необходимых параметров для работы криптосистемы, а именно:");
        System.out.println(
                "-генерация MasterPublicKey заданной длины (параметр security)");
        System.out.println(
                "-генерация MasterSecretKey заданной длины (параметр security)");
        System.out.println("При необходимости данные параметры сохраняются в файлы, указанный пользователем"
                + "(параметры -msk и -mpk)");
        System.out.println();
        System.out.println("Использование:");
        System.out.println(
                "setup  -security 'целое_положительное_число' [-mpk 'путь_к_файлу'] [-msk 'путь_к_файлам(2)']");
        System.out.println("------------------");
        ...
        System.out.println("------------------");
        System.out.println(
                "KeyExtract генерирует секретный ключ шифрования и подписи для пользователя с заданным текстовым идентификатором");
        System.out.println();
        System.out.println("Использование:");
        System.out.println(
                "keyextract [-mpk 'путь_к_файлу_с_публичным_ключом_системы]'-sk 'путь_к_файлу_с_cекретному_ключу' -sks 'путь_к_файлу_с_секретным_ключом_подписи'  -id 'адрес e-mail'");
        System.out.println("------------------");

        System.out.println("Информация о команде encrypt:");
        System.out.println("------------------");
        System.out.println(
                "encrypt производит шифрование и подпись заданного пользователем файла");
        System.out.println("Использование:");
        System.out.println(
                "encrypt [-mpk 'путь_к_файлу_с_открытым_ключом системы']  -id 'адрес e-mail'"
        ...
        System.out.println("------------------");
        System.out.println(
                "decrypt производит дешифрование и проверку подписи ранее зашифрованного файла");
        System.out.println("Использование:");
        System.out.println(
                "decrypt [-mpk 'путь_к_файлу_с_открытым_ключом системы'] [-sk 'путь_к_файлу_с_секретным_ключом']"
        ...
        System.out.println("------------------");
        System.out.println(
                "sign производит подпись заданного пользователем файла");
        System.out.println("Использование:");
        System.out.println(
                "sign  [-mpk 'путь_к_файлу_с_публичным_ключом'] -sks 'путь_к_файлу_с_секретным_ключом_для_подписи'  -id 'адрес_e-mail' -out 'путь_к_файлу_с_подпиcью");
        System.out.println("------------------");

        System.out.println("Информация о команде verify");
        System.out.println("------------------");
        System.out.println(
                "verify производит проверку подписи и возвращает результат проверки");
        System.out.println("Использование:");
        System.out.println(
                "verify [-mpk 'путь_к_файлу_с_публичным_ключом'] -in 'путь_к_файлу_с_подписью' ");
        System.out.println("------------------");
    }
    ...
    {
        System.out.println(
                "Введены неправильные параметры или отсутствуют обязательные параметры, напечатайте --help для вызова подсказки");
    }
