...
public class Arguments {
    ...
    public void verifyRequiredParameters()
    {
        ...
        if (this.command_type == 1 && (this.id == null || this.sk_path == null || this.sks_path == null))
          {
            Util.invalidParameters();
            System.exit(0);
          }
        ...
        if (this.command_type == 4 && (this.sks_path == null || this.id == null || this.in_path == null || this.out_path == null))
          {
            Util.invalidParameters();
            System.exit(0);
          }
